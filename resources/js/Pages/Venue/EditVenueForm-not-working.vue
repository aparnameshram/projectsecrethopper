...
const selectOptions = computed(() => page.props.selectOptions)
...
const openEditVenue = (venue) => {
    ...
    editVenue.value = true;
};

const closeEditVenue = () => {
...
<template>
    ...
    <Modal :show="editVenue" @close="closeEditVenue">
